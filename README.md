...
For more information, see the [project homepage](https://peter88213.github.io/noveltree_editor) with description and download instructions.
...
Name the binary file **noveltree_editor.mo**. 


### Install your translation for testing

Add a subdirectory tree to **noveltree/locale**, and place *noveltree_editor.mo* there, like this:
