...
Compatibility: noveltree v4.34 API

### v4.8.2

- Refactor the code for performance improvement.

Compatibility: noveltree v4.20 API
...
Compatibility: noveltree v4.13 API
...
Compatibility: noveltree v4.7 API
...
Compatibility: noveltree v0.42 API
...
Compatibility: noveltree v0.14.1 API
