...
[Download the latest release (version 0.99.0)](https://github.com/peter88213/noveltree_editor/raw/main/dist/noveltree_editor_v0.99.0.zip)

- Extract the "noveltree_editor_v0.99.0" folder from the downloaded zipfile "noveltree_editor_v0.99.0.zip".
