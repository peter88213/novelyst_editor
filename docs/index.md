...
[Download the latest release (version 3.0.3)](https://github.com/peter88213/novelyst_editor/raw/main/dist/novelyst_editor_v3.0.3.zip)

- Unzip the downloaded zipfile "novelyst_editor_v3.0.3.zip" into a new folder.
