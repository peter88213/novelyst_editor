...
[Download the latest release (version 4.5.0)](https://github.com/peter88213/novelyst_editor/raw/main/dist/novelyst_editor_v4.5.0.zip)

- Unzip the downloaded zipfile "novelyst_editor_v4.5.0.zip" into a new folder.
