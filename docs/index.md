...
[Download the latest release (version 0.7.0)](https://github.com/peter88213/novelyst_editor/raw/main/dist/novelyst_editor_v0.7.0.zip)

- Unzip the downloaded zipfile "novelyst_editor_v0.7.0.zip" into a new folder.
