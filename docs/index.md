...
[Download the latest release (version 0.2.2)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_editor_v0.2.2.zip)

- Unzip the downloaded zipfile "novelyst_editor_v0.2.2.zip" into a new folder.
