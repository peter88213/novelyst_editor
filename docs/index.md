...
[Download the latest release (version 5.0.0)](https://github.com/peter88213/novelyst_editor/raw/main/dist/novelyst_editor_v5.0.0.zip)

- Extract the "novelyst_editor_v5.0.0" folder from the downloaded zipfile "novelyst_editor_v5.0.0.zip".
